        ...
        <div class="m-5 flex flex-wrap justify-center mt-10 w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <div class="p-4 max-w-sm">
                <div class="flex flex-col items-center pb-10">
                    ...
                    <p class="text-sm text-gray-400" >Tipo: {{ $entity->type }}</p>
                    <p class="text-sm text-gray-400" >Poder: {{ $entity->power }}</p>
                    
                    @if(isset($entity->coach))
                            <p class="text-sm text-gray-400" >Coach: {{ $entity->coach->name }}</p>
                        @else
                            <p class="text-sm text-gray-400" >Sem treinador</p>
                        @endif
